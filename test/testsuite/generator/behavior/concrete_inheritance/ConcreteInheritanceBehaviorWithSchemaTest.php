...
class ConcreteInheritanceBehaviorWithSchemaTest extends SchemasTestBase
{
    ...
    {
        $behaviors = Propel1TestSchemaBookstoreBookPeer::getTableMap()->getBehaviors();
    ...
    {
        $second_hand_book = new Propel1TestSchemaSecondHandBooksSecondHandBook();
        $book = $second_hand_book->getParentOrCreate();
        $this->assertTrue($book instanceof Propel1TestSchemaBookstoreBook, 'getParentOrCreate() returns an instance of the parent class');
        $this->assertTrue($book->isNew(), 'getParentOrCreate() returns a new instance of the parent class if the object is new');
        $this->assertEquals('Propel1TestSchemaSecondHandBooksSecondHandBook', $book->getDescendantClass(), 'getParentOrCreate() correctly sets the descendant_class of the parent object');
    }
